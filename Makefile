...
clean:
	...
	rm -f tests/test_deepseek41_selected_small tests/test_deepseek41_scalar_queue tests/test_deepseek41_exact_tail tests/trace_deepseek41_prefill
...
tests/test_deepseek41_selected_small: tests/test_deepseek41_selected_small.c ds4.h $(CORE_OBJS)
	$(CC) $(CFLAGS) -I. -o $@ $< $(CORE_OBJS) $(METAL_LDLIBS)
